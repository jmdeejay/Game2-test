...
alarm_set(0, myTicks); // For sliding-in transition

// Unpack ds lists
for (var i = 0; i < ds_list_size(obj_LocalTavern.myMenu); i++) // For however long this list is...
{
	var _map = obj_LocalTavern.myMenu[| i]; // Pull the map at the list entry
