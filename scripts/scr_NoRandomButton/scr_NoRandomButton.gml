...
if (ds_grid_value_exists(G.cardData, 0, CARD, G.totalCards, CARD, myCard.noGoto))
{
...
{
	show_debug_message("Error, the value " + myCard.noGoto + " does not exist in the ds grid. Shutting down.");
	scr_ExitGame();
}
